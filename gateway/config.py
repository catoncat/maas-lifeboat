...
SAME_RETRY_DELAY_S = float(os.environ.get("MAAS_SAME_RETRY_DELAY_S", "1.0"))
ALT_RETRY_DELAY_S = float(os.environ.get("MAAS_ALT_RETRY_DELAY_S", "1.0"))
...
MAX_BACKEND_ATTEMPTS = max(1, int(os.environ.get("MAAS_MAX_BACKEND_ATTEMPTS", "7")))
